    ...
    <div class="pageContainer">
        ...
        <div class="px-[25px] pb-[25px] bg-white" x-data="{ activeTab: '{{ array_key_first($folders) }}' }">
            ...
            <p class="text-lg pb-3 text-[#3E3D56]">
                Az elmúlt években, évtizedekben az innovációmenedzsment weboldalt üzemeltető Glósz és Társa SYSTEM
                Csapata számos projektet bonyolított le a kutatás-fejlesztés, innovációmenedzsment, innovációmenedzsment
                képzés, iparjogvédelem, forrásszerzés, vállalati pénzügyi szolgáltatások területén. Referenciáinkban az
                elmúlt évek sikeres projektjeiből szemezgettünk.
            </p>
            <!-- Tabok -->
